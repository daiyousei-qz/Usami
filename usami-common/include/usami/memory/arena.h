...
#include "usami/memory/ptr-arithmetic.h"
#include <deque>
#include <cassert>
#include <algorithm>
#include <type_traits>
...
namespace usami
{
    ...
    class StackWorkspaceMemoryProvider
    {
    public:
        ...
        USAMI_DISABLE_COPY_AND_MOVE(StackWorkspaceMemoryProvider)
    ...
    class HeapWorkspaceMemoryProvider
    {
    public:
        ...
        USAMI_DISABLE_COPY_AND_MOVE(HeapWorkspaceMemoryProvider)
    ...
    class HeapGrowableMemoryProvider
    {
    public:
        HeapGrowableMemoryProvider()
        {
        }
        HeapGrowableMemoryProvider(size_t sz) : next_block_sz_(sz)
        {
        }

        USAMI_DISABLE_COPY_AND_MOVE(HeapGrowableMemoryProvider)
    ...
    public:
        ...
        USAMI_DISABLE_COPY_AND_MOVE(BasicArena);
